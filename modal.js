...
class SimpleModal {
    ...
    constructor(modalTitle, modalText, acceptText, cancelText, inputText) {
        ...
        this.inputText = inputText || false;
        ...
        this.inputText === true ? this._createQuestion() : this._createModal();
        // this._createModal();
    }
    ...
    _createQuestion() {
        ...
        input.setAttribute('id', 'UserText');
        input.classList.add('thin-ui-modal-input')
